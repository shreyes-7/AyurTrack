...
const features = [
  {
    ...
    description:
      "GPS-enabled tracking from farmers and wild collectors with precise location data and species identification.",
  ...
  },
  {
    ...
    description:
      "Automated enforcement of sustainability guidelines and quality thresholds via blockchain.",
  ...
  },
  {
    ...
    description:
      "FHIR-compliant testing with moisture, pesticide, and DNA validation at every step.",
  ...
  },
  {
    ...
    description:
      "Unique QR codes reveal complete provenance journey with interactive maps.",
  ...
  },
  {
    ...
    description:
      "Hyperledger Fabric-based ledger connecting all supply chain stakeholders.",
  ...
  },
  {
    ...
    description:
      "Immutable audit trail from collection to final formulation and retail.",
      ...
      <section className="relative min-h-[85vh] pt-16 pb-12 overflow-hidden">
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-4">
          <div className="text-center">
            ...
            {/* Main Heading - Fixed gradient and spacing */}
            {/* Main Heading - Lighter green gradient */}
            <motion.div
              initial={{ opacity: 0, y: -15 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <motion.h1
                className="text-4xl md:text-6xl font-black tracking-tight leading-[1.3] mb-6 px-4 py-2"
                style={{
                  background:
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              A permissioned network connecting every stakeholder in the supply
              chain
            </motion.p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              {...fadeInUp}
            >
              Advanced technology ensuring authenticity and transparency at
              every step
            </motion.p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              {...fadeInUp}
            >
              Leveraging cutting-edge blockchain technologies for security and
              reliability
            </motion.p>
          </div>
            ...
            {techStack.map((tech, i) => (
              ...
              >
                <div className="relative">
                  ...
                  <motion.div className="absolute top-2 right-2 text-green-400 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              {...fadeInUp}
            >
              Experience the power of decentralized trust and automated
              compliance
            </motion.p>
          </div>
        ...
        <AnimatedSection className="py-16 bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 text-center">
            ...
            <motion.p
              ...
              {...fadeInUp}
            >
              Join the revolution in Ayurvedic herb traceability with blockchain
              technology.
            </motion.p>
